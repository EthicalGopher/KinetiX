 ...
 */
export function useCameraController(session, device, outputs, { mirrorMode = 'auto', constraints = [], onSessionConfigSelected, allowBackgroundAudioPlayback, allowHapticsAndSystemSoundsPlayback, getInitialExposureBias, onError, onConfigured, getInitialZoom, }) {
