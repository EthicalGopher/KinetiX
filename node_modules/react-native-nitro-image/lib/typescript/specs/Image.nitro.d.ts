...
export interface Image extends HybridObject<{
    ...
    cropAsync(startX: number, startY: number, endX: number, endY: number): Promise<Image>;
    /**
     ...
     * ```
     */
    saveToFileAsync(path: string, format: ImageFormat, quality?: number): Promise<void>;
    /**
     ...
     * ```
     */
    saveToTemporaryFileAsync(format: ImageFormat, quality?: number): Promise<string>;
    /**
     ...
     */
    renderInto(image: Image, x: number, y: number, width: number, height: number): Image;
    renderIntoAsync(image: Image, x: number, y: number, width: number, height: number): Promise<Image>;
}
//# sourceMappingURL=Image.nitro.d.ts.map