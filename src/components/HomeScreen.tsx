...
const styles = StyleSheet.create({
  ...
  modalOverlay: { flex: 1, backgroundColor: 'rgba(15, 23, 42, 0.68)', justifyContent: 'center', alignItems: 'center' },
  modalCard: { width: '92%', backgroundColor: '#111827', borderRadius: 24, padding: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  modalTitle: { color: '#FFF', fontSize: 20, fontWeight: '800' },
  modalCloseIconText: { color: '#FFF', fontSize: 22, fontWeight: '700' },
  specCard: { backgroundColor: '#182030', borderRadius: 16, padding: 14, marginTop: 16 },
  specCardTitle: { color: '#FFF', fontSize: 16, fontWeight: '800', marginBottom: 8 },
  specDetailText: { color: '#CBD5E1', fontSize: 13, lineHeight: 20 },
  specHighlightText: { color: '#FFF', fontWeight: '700' },
  specRecommendText: { color: '#A7F3D0', fontWeight: '700' },
  modelSectionHeading: { color: '#F8FAFC', fontSize: 16, fontWeight: '700', marginTop: 18, marginBottom: 8 },
  optionCard: { backgroundColor: '#182030', borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  optionCardSelected: { borderColor: '#60A5FA', backgroundColor: '#1E293B' },
  ...
  recommendBadge: { backgroundColor: '#14532D', borderRadius: 10, paddingHorizontal: 8, paddingVertical: 3 },
  recommendBadgeText: { color: '#DCFCE7', fontSize: 10, fontWeight: '700' },
  optionDescription: { color: '#94A3B8', fontSize: 12, marginTop: 8, lineHeight: 18 },
  saveSettingsButton: { marginTop: 16, backgroundColor: '#2563EB', borderRadius: 14, paddingVertical: 12, alignItems: 'center' },
  saveSettingsButtonText: { color: '#FFF', fontSize: 15, fontWeight: '800' },
});
